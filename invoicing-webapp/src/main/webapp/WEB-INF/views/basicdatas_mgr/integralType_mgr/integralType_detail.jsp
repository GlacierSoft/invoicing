	...
	<table class="detailtable">
		<tr>
			...
			<td class="forminputtable"><!-- 当表格行存在两个要显示的td,使用该forminputtable样式可以进行适当的空间调整  -->
				<input type="hidden" name="creditTypeId" value="${creditTypeData.integralTypeId}" />
		...
		<tr>
			...
			<td>改变类型：</td>
			<td colspan="3"><input id="changeType" class="spinner" style="width:150px"  value="${creditTypeData.integralType}" readonly="readonly"/></td>
		</tr>
		<tr>
			<td>创建者：</td>
