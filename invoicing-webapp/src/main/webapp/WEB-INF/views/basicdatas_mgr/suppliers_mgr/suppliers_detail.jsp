	...
	<table class="detailtable">
	   <tr>
		...
		<tr>
			...
			<td>供应商类型:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.typeId}" readonly="readonly"/>
		    </td>
		</tr> 
		<tr>
		    <td>省份:</td>
		...
		<tr>
		    <td>供应商级别:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.supplierLevel}" readonly="readonly"/>
		    </td>
		    <td>供应商来源:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.sourceId}" readonly="readonly"/>
		    </td>
		</tr>
		<tr>
		    <td>公司性质:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.natureId}" readonly="readonly"/>
		    </td>
		    <td>公司行业:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.industryId}" readonly="readonly"/>
		    </td>
		</tr><tr>
		    <td>主营业务:</td>
			<td>
		    ...
		    <td>公司规模:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.sizeId}" readonly="readonly"/>
		    </td>
		</tr>
		<tr>
		    <td>注册资金:</td>
		...
		<tr>
		    ...
		    <td>上级供应商:</td>
			<td>
				 <input class="spinner" style="width:168px"  value="${suppliersData.supplierType}" readonly="readonly"/>
		    </td>
		</tr>
		<tr> 
		    <td>状态：</td>
		...
		<tr>  
			<td>备注:</td>
			<td colspan="3">
				 <input class="spinner" style="width:410px"  value="${suppliersData.remark}" readonly="readonly"/>
		    </td>
		</tr>
