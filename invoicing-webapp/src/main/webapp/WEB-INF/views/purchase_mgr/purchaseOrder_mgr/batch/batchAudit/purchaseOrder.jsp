...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.purchaseOrderDataGrid = $('#purchaseOrderDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseOrder/list.json?auditState=authstr',
	...
	//审核
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.batchAuditPurchaseOrder=function (){ 
		var rows =glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.purchaseOrderDataGrid.datagrid("getChecked");
		var purOrderIds = [];//id标识 
		...
		glacier.basicAddOrEditDialog({
			...
			width : 410,
			height : 250,
			queryUrl : ctx + '/do/purchaseOrder/auditFormList.htm',
			submitUrl : ctx + '/do/purchaseOrder/auditList.json',
			queryParams : {
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseOrderPanel" data-options="region:'center',border:true">
		<table id="purchaseOrderDataGrid">
			<glacierui:toolbar panelEnName="BatchAuditOrderList"
				toolbarId="purchaseOrderDataGrid_toolbar" menuEnName="batchAuditOrder" />
