...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.purchaseOrderDataGrid = $('#purchaseOrderDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseOrder/list.json?sta=sta',
	...
	//取消审核
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.batchCancelAuditPurchaseOrder=function (){
		...
		$.messager.confirm('请确认','是否要取消审核该记录?',function(r){
            if (r){
            	 $.ajax({ 
            		type: "POST",
            	    url : ctx+ '/do/purchaseOrder/batchCancelAudit.json',
					data : {
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseOrderPanel" data-options="region:'center',border:true">
		<table id="purchaseOrderDataGrid">
			<glacierui:toolbar panelEnName="BatchCancelAuditOrderList"
				toolbarId="purchaseOrderDataGrid_toolbar" menuEnName="batchCancelAuditOrder" />
