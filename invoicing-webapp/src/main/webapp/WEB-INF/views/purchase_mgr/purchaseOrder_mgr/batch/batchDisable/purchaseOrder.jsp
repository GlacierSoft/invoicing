...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.purchaseOrderDataGrid = $('#purchaseOrderDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseOrder/list.json?enabled=enable',
	...
	//禁用 
	glacier.purchase_mgr.purchaseOrder_mgr.purchaseOrder.batchDisablePurchaseOrder=function (){
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseOrderPanel" data-options="region:'center',border:true">
		<table id="purchaseOrderDataGrid">
			<glacierui:toolbar panelEnName="BatchDisableOrderList"
				toolbarId="purchaseOrderDataGrid_toolbar" menuEnName="batchDisableOrder" />
