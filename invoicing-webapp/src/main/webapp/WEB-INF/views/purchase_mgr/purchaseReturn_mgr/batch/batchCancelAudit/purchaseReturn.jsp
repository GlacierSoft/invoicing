...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.purchaseReturnDataGrid= $('#purchaseReturnDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseReturn/list.json?sta=sta',
	...
	//批量取消审核
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.batchCancelAuditPurchaseReturn=function(){ 
		...
		$.messager.confirm('请确认','是否要取消审核该记录?',function(r){
            if (r){
            	 $.ajax({ 
            		type: "POST",
            	    url : ctx+ '/do/purchaseReturn/batchCancelAudit.json',
					data : {
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseReturnPanel" data-options="region:'center',border:true">
		<table id="purchaseReturnDataGrid">
			<glacierui:toolbar panelEnName="BatchCancelAuditRetList"
				toolbarId="purchaseReturnDataGrid_toolbar" menuEnName="batchCancelAuditRet" />
