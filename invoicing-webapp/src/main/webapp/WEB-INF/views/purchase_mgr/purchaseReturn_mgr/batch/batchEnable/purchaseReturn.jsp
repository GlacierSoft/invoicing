...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.purchaseReturnDataGrid= $('#purchaseReturnDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseReturn/list.json?enabled=disable',
	...
	//批量启用
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.batchEnablePurchaseReturn=function(){ 
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseReturnPanel" data-options="region:'center',border:true">
		<table id="purchaseReturnDataGrid">
			<glacierui:toolbar panelEnName="BatchEnableRetList"
				toolbarId="purchaseReturnDataGrid_toolbar" menuEnName="batchEnableRet" />
