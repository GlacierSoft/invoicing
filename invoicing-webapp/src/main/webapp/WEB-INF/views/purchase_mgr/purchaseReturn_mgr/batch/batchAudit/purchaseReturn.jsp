...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.param = {
		...
		actions : {  
			   batchAudit:{flag:'batchAudit',controlType:'multiple'}  
	         }
     };
	...
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.purchaseReturnDataGrid= $('#purchaseReturnDataGrid').datagrid({
		...
		url : ctx + '/do/purchaseReturn/list.json?auditState=authstr',
	...
	//审核
	glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.batchAuditPurchaseReturn=function(){ 
		var rows =glacier.purchase_mgr.purchaseReturn_mgr.purchaseReturn.purchaseReturnDataGrid.datagrid("getChecked");
		var purReturnIds = [];//id标识 
		...
		glacier.basicAddOrEditDialog({
			...
			width : 410,
			height : 250,
			queryUrl : ctx + '/do/purchaseReturn/auditFormList.htm',
			submitUrl : ctx + '/do/purchaseReturn/auditList.json',
			queryParams : {
				purReturnIds : purReturnIds
			},
			successFun : function (){
...
<div class="easyui-layout" data-options="fit:true">
	<div id="purchaseReturnPanel" data-options="region:'center',border:true">
		<table id="purchaseReturnDataGrid">
			<glacierui:toolbar panelEnName="BatchAuditRetList"
				toolbarId="purchaseReturnDataGrid_toolbar" menuEnName="batchAuditRet" />
