...
<script type="text/javascript">
	...
	glacier.purchase_mgr.purchaseArrival_mgr.purchaseArrival.purchaseArrivalDataGrid = $('#purchaseArrivalDataGrid').datagrid({
		...
		url: ctx + '/do/purchaseArrival/list.json?auditState=authstr',
	...
	//点击批量审核按钮触发方法
	glacier.purchase_mgr.purchaseArrival_mgr.purchaseArrival.batchAuditPurchaseArrival = function(){
		var rows = glacier.purchase_mgr.purchaseArrival_mgr.purchaseArrival.purchaseArrivalDataGrid.datagrid("getChecked");
		var purchaseArrivalIds = [];//存储需要审核的id标识 
		...
		glacier.basicAddOrEditDialog({
			...
			width : 410,
			height : 250,
			queryUrl : ctx + '/do/purchaseArrival/batchAuditForm.htm',
