(function() { 
	$(".proCitySelAll").click(function(event) {
		...
		$(".provinceCityAll").find(".tabsArea").find("a").removeClass("current");
		$(".provinceCityAll").find(".tabsArea").find("a[tb=hotCityAll]").addClass("current");
		...
		// }
		 //if ($("body").data("allCountys") == null) {
			sendAllCountiesAjax();
		// }
		$(".provinceCityAll").find(".tabsArea").find("a").click(function() {
			...
			if (currentClass == "proCityQuery")
			 {
				...
				$(".provinceCity").find(".tabsArea").find("a").removeClass("current");
				$(".provinceCity .tabsArea").find("#county").addClass("current");
			 ...
			 else if (currentClass == "proCityQueryAll")
			 {
				...
				$(".provinceCityAll").find(".tabsArea").find("a").removeClass("current");
				$(".provinceCityAll .tabsArea").find("#countyAll").addClass("current");
			...
			if (currentClass == "proCityQuery")
			 {
				...
				$(".provinceCity").find(".tabsArea").find("a").removeClass("current");
				$(".provinceCity").find(".tabsArea").find("a[tb=hotCity]").addClass("current");
...
function viewCities(i) {
	...
	$(".provinceCity").find(".tabsArea").find("a").removeClass("current");
	$(".provinceCity .tabsArea").find("#city").addClass("current");
...
function sendAllProvinceAjax() { 
	$.ajax({
		type: "get",
		url: 'http://localhost:8888/yhglobal-webapp/resources/area/js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() { 
	$.ajax({
		type: "get",
		url: 'http://localhost:8888/yhglobal-webapp/resources/area/js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 { 
	$.ajax({
		type: "get",
		url: "http://localhost:8888/yhglobal-webapp/resources/area/js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
...
function viewAllCities(i) {
	...
	$(".provinceCityAll").find(".tabsArea").find("a").removeClass("current");
	$(".provinceCityAll .tabsArea").find("#cityAll").addClass("current");
	$(".con .provinceAll .list a").removeClass("current");
