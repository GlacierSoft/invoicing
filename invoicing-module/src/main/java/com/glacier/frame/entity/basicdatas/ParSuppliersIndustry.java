...
public class ParSuppliersIndustry {
    ...
    public boolean equals(Object that) {
        ...
        ParSuppliersIndustry other = (ParSuppliersIndustry) that;
        return (this.getIndustryId() == null ? other.getIndustryId() == null : this.getIndustryId().equals(other.getIndustryId()))
            ...
            && (this.getIndustyCode() == null ? other.getIndustyCode() == null : this.getIndustyCode().equals(other.getIndustyCode()))
