...
public class ParSellReturn_reasonId {
    ...
    public boolean equals(Object that) {
        ...
        ParSellReturn_reasonId other = (ParSellReturn_reasonId) that;
        return (this.getReturnReasonId() == null ? other.getReturnReasonId() == null : this.getReturnReasonId().equals(other.getReturnReasonId()))
            && (this.getCode() == null ? other.getCode() == null : this.getCode().equals(other.getCode()))
            && (this.getReturnReasonName() == null ? other.getReturnReasonName() == null : this.getReturnReasonName().equals(other.getReturnReasonName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getReturnReasonName() == null) ? 0 : getReturnReasonName().hashCode());
