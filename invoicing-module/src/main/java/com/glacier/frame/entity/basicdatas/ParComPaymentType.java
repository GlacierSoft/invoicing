...
public class ParComPaymentType {
    ...
    public boolean equals(Object that) {
        ...
        ParComPaymentType other = (ParComPaymentType) that;
        return (this.getPaymentTypeId() == null ? other.getPaymentTypeId() == null : this.getPaymentTypeId().equals(other.getPaymentTypeId()))
