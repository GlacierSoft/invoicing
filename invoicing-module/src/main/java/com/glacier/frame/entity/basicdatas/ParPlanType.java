...
public class ParPlanType {
    ...
    public boolean equals(Object that) {
        ...
        ParPlanType other = (ParPlanType) that;
        return (this.getPlanTypeId() == null ? other.getPlanTypeId() == null : this.getPlanTypeId().equals(other.getPlanTypeId()))
