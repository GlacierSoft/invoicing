...
public class ParSuppliersGrade {
    ...
    public boolean equals(Object that) {
        ...
        ParSuppliersGrade other = (ParSuppliersGrade) that;
        return (this.getGradeId() == null ? other.getGradeId() == null : this.getGradeId().equals(other.getGradeId()))
            ...
            && (this.getGradeCode() == null ? other.getGradeCode() == null : this.getGradeCode().equals(other.getGradeCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGradeCode() == null) ? 0 : getGradeCode().hashCode());
