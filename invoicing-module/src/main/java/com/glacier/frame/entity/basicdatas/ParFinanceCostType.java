...
public class ParFinanceCostType {
    ...
    public boolean equals(Object that) {
        ...
        ParFinanceCostType other = (ParFinanceCostType) that;
        return (this.getCostTypeId() == null ? other.getCostTypeId() == null : this.getCostTypeId().equals(other.getCostTypeId()))
