...
public class ParPurchaseType {
    ...
    public boolean equals(Object that) {
        ...
        ParPurchaseType other = (ParPurchaseType) that;
        return (this.getPurchaseTypeId() == null ? other.getPurchaseTypeId() == null : this.getPurchaseTypeId().equals(other.getPurchaseTypeId()))
