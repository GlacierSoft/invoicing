...
/**
 * @ClassName: BasisClientQueryDTO 
 * @Description: TODO(客户档案查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-9
 */
public class BasisClientQueryDTO extends BasisClient{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getClientName() && StringUtils.isNotBlank(this.getClientName())){//客户档案名称Like查询
            queryCriteria.andClientNameLike("%" + this.getClientName() + "%");
        }  
