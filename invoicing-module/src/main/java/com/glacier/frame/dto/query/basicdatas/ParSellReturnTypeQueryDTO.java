/*
 * @(#)ParSellReturnTypeQueryDTO.java
 * @author wuting
...
/**
 * @ClassName: ParSellReturnTypeQueryDTO 
 * @Description: TODO(销销售退货方式查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParSellReturnTypeQueryDTO extends ParSellReturnType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getReturnTypeName() && StringUtils.isNotBlank(this.getReturnTypeName())){//销销售退货方式名称Like查询
            queryCriteria.andReturnTypeNameLike("%" + this.getReturnTypeName() + "%");
        }  
