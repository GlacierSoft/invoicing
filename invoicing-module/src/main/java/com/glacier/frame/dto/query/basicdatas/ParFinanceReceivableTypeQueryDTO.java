/*
 * @(#)ParFinanceReceivableTypeQueryDTO.java
 * @author wuting
...
/**
 * @ClassName: ParFinanceReceivableTypeQueryDTO 
 * @Description: TODO(应收类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParFinanceReceivableTypeQueryDTO extends ParFinanceReceivableType{
   ...
   public String getLoginStartCount() {
    ...
    public void setQueryCondition(Criteria queryCriteria){
     if(null != this.getName() && StringUtils.isNotBlank(this.getName())){//应收类型名称Like查询
