...
/**
 * @ClassName: ParClientContactQueryDTO 
 * @Description: TODO(客户联系人查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParClientContactQueryDTO extends ParClientContact{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getName() && StringUtils.isNotBlank(this.getName())){//客户联系人名称Like查询
