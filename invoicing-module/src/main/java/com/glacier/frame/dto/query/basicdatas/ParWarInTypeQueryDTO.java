...
/**
 * @ClassName: ParWarInTypeQueryDTO 
 * @Description: TODO(入库业务类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-14
 */
public class ParWarInTypeQueryDTO extends ParWarInType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getInTypeName() && StringUtils.isNotBlank(this.getInTypeName())){//入库业务类型名称Like查询
            queryCriteria.andInTypeNameLike("%" + this.getInTypeName() + "%");
        }  
