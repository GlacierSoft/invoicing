...
/**
 * @ClassName: ParClientLevelQueryDTO 
 * @Description: TODO(客户等级查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParClientLevelQueryDTO extends ParClientLevel{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getClientLevelName() && StringUtils.isNotBlank(this.getClientLevelName())){//客户等级名称Like查询
            queryCriteria.andClientLevelNameLike("%" + this.getClientLevelName() + "%");
        }  
