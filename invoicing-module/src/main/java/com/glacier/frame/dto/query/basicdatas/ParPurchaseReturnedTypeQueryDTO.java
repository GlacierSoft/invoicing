/**
 * @Title: ParPurchaseReturnedTypeQueryDTO.java 
 * @Package com.glacier.frame.dto.query.basicdatas 
 * @author song.jundong   
 * @email 985776597@qq.com
 * @date 2015-1-13 上午10:51:44 
...
/**
 * @ClassName:  ParPurchaseReturnedTypeQueryDTO
 * @Description: TODO(采购退货方式)
 * @author songjundong
 * @email 985776597@QQ.com
 * @date 2015-1-13  上午10:51:44
 */
public class ParPurchaseReturnedTypeQueryDTO extends ParPurchaseReturnedType{
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getName() && StringUtils.isNotBlank(this.getName())){//名称Like查询
