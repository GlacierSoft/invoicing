...
/**
 * @ClassName: ParDeliverTypeQueryDTO 
 * @Description: TODO(交货方式查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-8
 */
public class ParComDeliverTypeQueryDTO extends ParComDeliverType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getDeliverTypeName() && StringUtils.isNotBlank(this.getDeliverTypeName())){//交货方式名称Like查询
            queryCriteria.andDeliverTypeNameLike("%" + this.getDeliverTypeName() + "%");
        }  
