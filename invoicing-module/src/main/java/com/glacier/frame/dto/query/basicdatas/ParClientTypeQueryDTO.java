...
/**
 * @ClassName: ParClientTypeQueryDTO 
 * @Description: TODO(客户类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParClientTypeQueryDTO extends ParClientType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getClientTypeName() && StringUtils.isNotBlank(this.getClientTypeName())){//客户类型名称Like查询
            queryCriteria.andClientTypeNameLike("%" + this.getClientTypeName() + "%");
        }  
