/*
 * @(#)ParSuppliersContactQueryDTO.java
 * @author wuting
...
/**
 * @ClassName: ParSuppliersContactQueryDTO 
 * @Description: TODO(供应商联系人查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParSuppliersContactQueryDTO extends ParSuppliersContact{
