...
/**
 * @ClassName: ParSellTypeQueryDTO 
 * @Description: TODO(销销售类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParSellTypeQueryDTO extends ParSellType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getSellTypeName() && StringUtils.isNotBlank(this.getSellTypeName())){//销销售类型名称Like查询
            queryCriteria.andSellTypeNameLike("%" + this.getSellTypeName() + "%");
        }  
