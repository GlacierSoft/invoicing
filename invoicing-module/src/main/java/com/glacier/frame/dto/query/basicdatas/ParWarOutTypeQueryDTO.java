...
/**
 * @ClassName: ParWarOutTypeQueryDTO 
 * @Description: TODO(出库业务类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-14
 */
public class ParWarOutTypeQueryDTO extends ParWarOutType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getOutTypeName() && StringUtils.isNotBlank(this.getOutTypeName())){//出库业务类型名称Like查询
            queryCriteria.andOutTypeNameLike("%" + this.getOutTypeName() + "%");
        }  
