/*
 * @(#)ParSellReturnReasonQueryDTO.java
 * @author wuting
...
/**
 * @ClassName: ParSellReturnReasonQueryDTO 
 * @Description: TODO(销售退货原因查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParSellReturnReasonQueryDTO extends ParSellReturnReason{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getReturnReasonName() && StringUtils.isNotBlank(this.getReturnReasonName())){//销售退货原因名称Like查询
            queryCriteria.andReturnReasonNameLike("%" + this.getReturnReasonName() + "%");
        }  
