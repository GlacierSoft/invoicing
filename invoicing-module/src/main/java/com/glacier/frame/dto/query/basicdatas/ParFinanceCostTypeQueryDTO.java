/*
 * @(#)ParFinanceCostTypeQueryDTO.java
 * @author wuting
...
/**
 * @ClassName: ParFinanceCostTypeQueryDTO 
 * @Description: TODO(费用类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2015-1-13
 */
public class ParFinanceCostTypeQueryDTO extends ParFinanceCostType{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getName() && StringUtils.isNotBlank(this.getName())){//费用类型名称Like查询
